...
print("DEBUG: CoM iniziale (statico):", com0)
x0[:3] = com0.copy()
...
print(results)
print("DEBUG: Numero di thread usati nel solver =", solver.num_threads)
...
weights_IKID = [500, 50000, 10, 1000, 100] #[1000, 80000, 10, 2000, 200]  # qref, foot_pose, centroidal, base_rot, force
...
for t in range(T_mpc):
    ...
    term_constraint_com = aligator.StageConstraint(
        centroidal_com, constraints.EqualityConstraintSet()
    )
    ...
    #print("DEBUG: CoM aggiornato):", com0)
